								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="text" value="<?= $user->username_user ?>" name="username" class="form-control" id="exampleInputEmail1" placeholder="Masukkan username">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="text" value="<?= $user->password_user ?>" name="password" class="form-control" id="exampleInputEmail1" placeholder="Masukkan password">
