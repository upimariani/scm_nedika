					...
					<div class="invoice p-3 mb-3">
						...
						<div class="row no-print">
							<div class="col-12">
								...
								?>
									<a href="<?= base_url('Supplier/cTransaksi/konfirmasi/' . $transaksi['transaksi']->id_po_bb) ?>" class="mt-5 btn btn-warning"><i class="fas fa-pen-alt"></i> Konfirmasi Pesanan</a>

								<?php
								}
								?>
								<?php
								if ($transaksi['transaksi']->status_order == '2') {
								?>
									<a href="<?= base_url('Supplier/cTransaksi/kirim/' . $transaksi['transaksi']->id_po_bb) ?>" class="mt-5 btn btn-info"><i class="fas fa-car"></i> Pesanan Dikirim</a>
