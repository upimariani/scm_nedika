					...
					<div class="invoice p-3 mb-3">
						...
						<div class="row">
							...
							<div class="col-6">
								...
								?>
									<?php echo form_open_multipart('Gudang/cTransaksi/bayar/' . $transaksi['transaksi']->id_po_bb); ?>
						...
						<div class="row no-print">
							<div class="col-12">
								...
								?>
									<a href="<?= base_url('Gudang/cTransaksi/pesanan_diterima/' . $transaksi['transaksi']->id_po_bb) ?>" class="mt-5 btn btn-success"><i class="fas fa-pen-alt"></i> Konfirmasi Diterima</a>
