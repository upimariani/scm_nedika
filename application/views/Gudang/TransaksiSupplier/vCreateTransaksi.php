					...
					<div class="card card-warning">
						...
						<form action="<?= base_url('Gudang/cTransaksi/addtocart') ?>" method="POST" role="form">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<select class="form-control" id="bb" name="bahanbaku" required>
												...
												?>
													<option data-nama="<?= $value->nama_bb ?>" data-harga="<?= $value->harga_bb ?>" data-stok="<?= $value->stok_supplier ?>" value="<?= $value->id_bb ?>"><?= $value->nama_bb ?></option>
												<?php
												}
												?>
							...
							<div class="card-footer">
								<button type="submit" class="btn btn-warning"><i class="fas fa-shopping-basket"></i>Add To Cart</button>
