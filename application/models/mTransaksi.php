...
class mTransaksi extends CI_Model
{
	...
	public function detail_transaksi($id)
	{
		...
		$data['detail'] = $this->db->query("SELECT * FROM `po_bb` JOIN po_dbb ON po_bb.id_po_bb=po_dbb.id_po_bb JOIN bahan_baku ON po_dbb.id_bb=bahan_baku.id_bb WHERE po_bb.id_po_bb='" . $id . "'")->result();
		return $data;
	}
